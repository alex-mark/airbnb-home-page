...
function SearchPage() {
  return (
    <div className="searchPage">
      ...
      <SearchResult
        img="https://media.cntraveler.com/photos/5a8f258bd363c34048b35aac/master/2_2250,h_1500,c_limit/airbnb-plus-london.jpg"
        location="Private toom in center of London"
      ...
      <SearchResult
        ...
        description="2 guest - 1 bedroom - 1 bed - 1.5 shared bathrooms - WiFi - Free parking - Washing Machine"
        star={4.23}
        price="$65 / night"
        total="$480 total"
      />
